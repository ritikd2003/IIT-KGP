"""
Plot vorticity planes from joint analysis files.
...
def main(filename, start, count, output):
    """Save plot of vorticity for the given range of analysis writes."""

    # Plot settings
    task = 'vorticity'  # Only plot vorticity
    scale = 2
    dpi = 200
